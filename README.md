...
[![Version](http://img.shields.io/badge/version-1.0.0-blue.svg?style=flat)](https://github.com/chrischristo/capsule-maven-plugin-demo/releases)
...
```
java -jar target/capsule-maven-plugin-demo-1.0.0-capsule-empty.jar
java -jar target/capsule-maven-plugin-demo-1.0.0-capsule-thin.jar
java -jar target/capsule-maven-plugin-demo-1.0.0-capsule-fat.jar
```
...
```
./target/capsule-maven-plugin-demo-1.0.0-capsule-empty.x
./target/capsule-maven-plugin-demo-1.0.0-capsule-thin.x
./target/capsule-maven-plugin-demo-1.0.0-capsule-fat.x
```
