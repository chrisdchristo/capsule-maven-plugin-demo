...
[![Version](http://img.shields.io/badge/version-0.10.5-blue.svg?style=flat)](https://github.com/chrischristo/capsule-maven-plugin-demo/releases)
...
```
java -jar target/capsule-maven-plugin-demo-0.10.5-capsule-empty.jar
java -jar target/capsule-maven-plugin-demo-0.10.5-capsule-thin.jar
java -jar target/capsule-maven-plugin-demo-0.10.5-capsule-fat.jar
```
...
```
./target/capsule-maven-plugin-demo-0.10.5-capsule-empty.x
./target/capsule-maven-plugin-demo-0.10.5-capsule-thin.x
./target/capsule-maven-plugin-demo-0.10.5-capsule-fat.x
```
