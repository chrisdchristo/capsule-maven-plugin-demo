...
[![Version](http://img.shields.io/badge/version-0.10.7-blue.svg?style=flat)](https://github.com/chrischristo/capsule-maven-plugin-demo/releases)
...
```
java -jar target/capsule-maven-plugin-demo-0.10.7-capsule-empty.jar
java -jar target/capsule-maven-plugin-demo-0.10.7-capsule-thin.jar
java -jar target/capsule-maven-plugin-demo-0.10.7-capsule-fat.jar
```
...
```
./target/capsule-maven-plugin-demo-0.10.7-capsule-empty.x
./target/capsule-maven-plugin-demo-0.10.7-capsule-thin.x
./target/capsule-maven-plugin-demo-0.10.7-capsule-fat.x
```
