...
[![Version](http://img.shields.io/badge/version-0.9.1-blue.svg?style=flat)](https://github.com/chrischristo/capsule-maven-plugin-demo/releases)
...
```
java -jar target/capsule-maven-plugin-demo-0.9.1-capsule-empty.jar
java -jar target/capsule-maven-plugin-demo-0.9.1-capsule-thin.jar
java -jar target/capsule-maven-plugin-demo-0.9.1-capsule-fat.jar
```
...
```
./target/capsule-maven-plugin-demo-0.9.1-capsule-empty.x
./target/capsule-maven-plugin-demo-0.9.1-capsule-thin.x
./target/capsule-maven-plugin-demo-0.9.1-capsule-fat.x
```
